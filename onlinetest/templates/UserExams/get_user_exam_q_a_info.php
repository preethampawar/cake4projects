...
if (!empty($selectedQA)) {
    ...
    <div class="rounded border bg-light px-1 pt-2 pb-1">
        ...
        <div class="text-center">
            ...
            <div class="mt-2">
                ...
                <span class="btn btn-sm rounded-pill btn-outline-danger px-3">Unanswered - <?= $unanswered ?></span>
            </div>
        </div>
        <hr class="m-3">
        ...
        <div class="text-center">
            ...
            foreach ($selectedQA as $row) {
                ...
                $isAttempted = (bool)$row['attempted_question_id'];
                $bgClass = $isAttempted ? 'btn-success-light' : 'btn-outline-danger';
