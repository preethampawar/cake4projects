...
//    public $userManagementActionUrl = '//www.usermanagement-local.com:8080/Users/appRequestAction/';
    ...
    protected function isBatchSelected()
    {
        return $this->request->getSession()->check('Batch.id') == true;
    }

    protected function getSelectedBatchId()
    {
        return $this->request->getSession()->read('Batch.id');
    }
